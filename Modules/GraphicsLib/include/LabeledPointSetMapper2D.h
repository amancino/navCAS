...
#ifndef navcas_LabeledPointSetMapper2D_h
#define navcas_LabeledPointSetMapper2D_h
...
* between points.
*
* @section mitkLabeledPointSetMapper2D_point_rep Point Representation
*
...
* pipeline.
*
* @section mitkLabeledPointSetMapper2D_propertires Applicable Properties
*
* Properties that can be set for point sets and influence the LabeledPointSetMapper2D are:
*
...
* @ingroup Mapper
*/
class GraphicsLib_EXPORT LabeledPointSetMapper2D : public mitk::VtkMapper
{
public:
  mitkClassMacro(LabeledPointSetMapper2D, mitk::VtkMapper);
...
protected:
  /* constructor */
  LabeledPointSetMapper2D();

  /* destructor */
  ~LabeledPointSetMapper2D() override;
...
#endif /* navcas_LabeledPointSetMapper2D_h */
