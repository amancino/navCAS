...
#ifndef NAVCAS_WORKBENCHWINDOW_ADVISOR_H_
#define NAVCAS_WORKBENCHWINDOW_ADVISOR_H_
...
class navCASWorkbenchWindowAdvisor : public QObject, public berry::WorkbenchWindowAdvisor
{
	Q_OBJECT

public:

	navCASWorkbenchWindowAdvisor(berry::WorkbenchAdvisor* wbAdvisor,
		berry::IWorkbenchWindowConfigurer::Pointer configurer);

	~navCASWorkbenchWindowAdvisor() override;
...
private:
	...
	friend struct berry::PropertyChangeIntAdapter<navCASWorkbenchWindowAdvisor>;
...
#endif /*NAVCAS_WORKBENCHWINDOW_ADVISOR_H_*/
