...
QString navCASWorkbenchWindowAdvisor::QT_SETTINGS_FILENAME = "QtSettings.ini";
...
public:
	...
	PartListenerForTitle(navCASWorkbenchWindowAdvisor* wa)
		: windowAdvisor(wa)
	{
	}
...
private:
	navCASWorkbenchWindowAdvisor* windowAdvisor;
};
...
public:
	...
	PerspectiveListenerForTitle(navCASWorkbenchWindowAdvisor* wa)
		: windowAdvisor(wa)
...
public:
	...
	PerspectiveListenerForMenu(navCASWorkbenchWindowAdvisor* wa)
		: windowAdvisor(wa)
	{
	}
...
private:
	...
	navCASWorkbenchWindowAdvisor::navCASWorkbenchWindowAdvisor(berry::WorkbenchAdvisor* wbAdvisor,
	...
	, dropTargetListener(new QmitkDefaultDropTargetListener)
{
  ...
  viewExcludeList.push_back("org.mitk.views.datamanager");

  perspectiveExcludeList.push_back("");
}

	navCASWorkbenchWindowAdvisor::~navCASWorkbenchWindowAdvisor()
{
}

berry::ActionBarAdvisor::Pointer navCASWorkbenchWindowAdvisor::CreateActionBarAdvisor(berry::IActionBarConfigurer::Pointer configurer)
{
	if (USE_EXPERIMENTAL_COMMAND_CONTRIBUTIONS)
	{
...
QWidget* navCASWorkbenchWindowAdvisor::CreateEmptyWindowContents(QWidget* parent)
{
...
void navCASWorkbenchWindowAdvisor::ShowClosePerspectiveMenuItem(bool show)
{
	showClosePerspectiveMenuItem = show;
}

bool navCASWorkbenchWindowAdvisor::GetShowClosePerspectiveMenuItem()
{
	return showClosePerspectiveMenuItem;
}

void navCASWorkbenchWindowAdvisor::ShowMemoryIndicator(bool show)
{
	showMemoryIndicator = show;
}

bool navCASWorkbenchWindowAdvisor::GetShowMemoryIndicator()
{
	return showMemoryIndicator;
}

void navCASWorkbenchWindowAdvisor::ShowNewWindowMenuItem(bool show)
{
	showNewWindowMenuItem = show;
}

void navCASWorkbenchWindowAdvisor::ShowViewToolbar(bool show)
{
	showViewToolbar = show;
}

void navCASWorkbenchWindowAdvisor::ShowViewMenuItem(bool show)
{
	showViewMenuItem = show;
}

void navCASWorkbenchWindowAdvisor::ShowPerspectiveToolbar(bool show)
{
	showPerspectiveToolbar = show;
}

void navCASWorkbenchWindowAdvisor::ShowVersionInfo(bool show)
{
	showVersionInfo = show;
}

void navCASWorkbenchWindowAdvisor::ShowMitkVersionInfo(bool show)
{
	showMitkVersionInfo = show;
}

void navCASWorkbenchWindowAdvisor::SetProductName(const QString& product)
{
	productName = product;
}

void navCASWorkbenchWindowAdvisor::SetWindowIcon(const QString& wndIcon)
{
	windowIcon = wndIcon;
}

void navCASWorkbenchWindowAdvisor::PostWindowCreate()
{
	// very bad hack...
  ...
  auto fileOpenAction = new navCASFileOpenAction(berry::QtStyleManager::ThemeIcon(basePath + "document-open.svg"), window);
  ...
  fileSaveProjectAction = new navCASFileSaveProjectAction(window);
...
//			QKeySequence("CTRL+Y"));
		...
		windowMenu->addSeparator();
	//	resetPerspAction = windowMenu->addAction("&Reset Perspective", QmitkExtWorkbenchWindowAdvisorHack::undohack, SLOT(onResetPerspective()));
...
void navCASWorkbenchWindowAdvisor::PreWindowOpen()
{
...
void navCASWorkbenchWindowAdvisor::PostWindowOpen()
{
	berry::WorkbenchWindowAdvisor::PostWindowOpen();
	// Force Rendering Window Creation on startup.
	berry::IWorkbenchWindowConfigurer::Pointer configurer = GetWindowConfigurer();

	//ctkPluginContext* context = navCASCommonExtPlugin::getContext();
...
void navCASWorkbenchWindowAdvisor::onIntro()
{
	//QmitkExtWorkbenchWindowAdvisorHack::undohack->onIntro();
}

void navCASWorkbenchWindowAdvisor::onHelp()
{
	//QmitkExtWorkbenchWindowAdvisorHack::undohack->onHelp();
}

void navCASWorkbenchWindowAdvisor::onHelpOpenHelpPerspective()
{
	//QmitkExtWorkbenchWindowAdvisorHack::undohack->onHelpOpenHelpPerspective();
}

void navCASWorkbenchWindowAdvisor::onAbout()
{
...
void navCASWorkbenchWindowAdvisor::HookTitleUpdateListeners(berry::IWorkbenchWindowConfigurer::Pointer configurer)
{
	...
	editorPropertyListener.reset(new berry::PropertyChangeIntAdapter<
		navCASWorkbenchWindowAdvisor>(this,
			&navCASWorkbenchWindowAdvisor::PropertyChange));
...
QString navCASWorkbenchWindowAdvisor::ComputeTitle()
{
	berry::IWorkbenchWindowConfigurer::Pointer configurer = GetWindowConfigurer();
...
void navCASWorkbenchWindowAdvisor::RecomputeTitle()
{
	berry::IWorkbenchWindowConfigurer::Pointer configurer = GetWindowConfigurer();
...
void navCASWorkbenchWindowAdvisor::UpdateTitle(bool editorHidden)
{
	berry::IWorkbenchWindowConfigurer::Pointer configurer = GetWindowConfigurer();
...
void navCASWorkbenchWindowAdvisor::PropertyChange(const berry::Object::Pointer& /*source*/, int propId)
{
...
void navCASWorkbenchWindowAdvisor::SetPerspectiveExcludeList(const QList<QString>& v)
{
	this->perspectiveExcludeList = v;
}

QList<QString> navCASWorkbenchWindowAdvisor::GetPerspectiveExcludeList()
{
	return this->perspectiveExcludeList;
}

void navCASWorkbenchWindowAdvisor::SetViewExcludeList(const QList<QString>& v)
{
	this->viewExcludeList = v;
}

QList<QString> navCASWorkbenchWindowAdvisor::GetViewExcludeList()
{
	return this->viewExcludeList;
}

void navCASWorkbenchWindowAdvisor::PostWindowClose()
{
	berry::IWorkbenchWindow::Pointer window = this->GetWindowConfigurer()->GetWindow();
...
QString navCASWorkbenchWindowAdvisor::GetQSettingsFile() const
{
